...
export default function ComposeEmail({
  ...
  useEffect(() => {
    api
      .get('/api/senders')
      .then((res: any) => setSenders(res.data.data))
      .catch((err: any) => {
  ...
  const handleFileUpload = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    if (uploadedFile) {
      ...
      reader.onload = (event) => {
        ...
        toast.success(
          `Detected ${uniqueEmails.length} email addresses`
        );
      };
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    if (finalRecipients.length === 0) {
      toast.error(
        'No valid recipients found. Please type email(s) or upload a list.'
      );
    ...
    try {
      ...
      const matched = senders.find(
        (sender) => sender.email === data.senderEmail
      );
      ...
      if (matched) {
        ...
        toast.loading(
          'Registering custom sender email account...',
          {
            id: 'sender-reg',
          }
        );
      ...
      <div className="bg-white rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.1)] w-full max-w-4xl flex flex-col max-h-[92vh] border border-[#e4e8eb] overflow-hidden relative">
              ...
              <div className="absolute right-0 top-12 w-[280px] bg-white border border-[#e4e8eb] rounded-2xl shadow-[0_4px_24px_rgba(0,0,0,0.08)] p-4 z-50 space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      setTempTime(getTomorrowPreset(9, 0))
                    }
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      setTempTime(getTomorrowPreset(10, 0))
                    }
                    className="w-full text-left px-3 py-2 hover:bg-[#f4f6f8] rounded-lg text-xs font-semibold text-gray-700 transition-colors"
                  >
                    Tomorrow, 10:00 AM
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      setTempTime(getTomorrowPreset(11, 0))
                    }
                    className="w-full text-left px-3 py-2 hover:bg-[#f4f6f8] rounded-lg text-xs font-semibold text-gray-700 transition-colors"
                  >
                    Tomorrow, 11:00 AM
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      setTempTime(getTomorrowPreset(15, 0))
                    }
                    className="w-full text-left px-3 py-2 hover:bg-[#f4f6f8] rounded-lg text-xs font-semibold text-gray-700 transition-colors"
                  >
                    Tomorrow, 3:00 PM
        ...
        >
          ...
          <div className="flex items-center gap-4 border-b border-[#f0f2f5] pb-3">
            ...
            <label className="w-24 text-xs font-bold text-gray-500">
              From:
            </label>
          ...
          <div className="flex flex-wrap items-center gap-6 pt-2 pb-4 border-b border-[#f0f2f5]">
            ...
            <div className="text-xs font-semibold text-gray-400 ml-auto">
              Schedule:{' '}
              <span className="text-[#00a854] font-bold">
          ...
          <div className="space-y-2">
            ...
            <div className="border border-[#e4e8eb] rounded-2xl overflow-hidden flex flex-col">
              ...
              <div className="bg-[#fafbfc] border-b border-[#e4e8eb] px-4 py-2 flex items-center gap-2">
                ...
                <button
                  type="button"
                  className="p-1.5 hover:bg-gray-100 rounded-lg text-gray-500 cursor-pointer transition-colors"
                >
