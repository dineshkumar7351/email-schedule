...
const SlackIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M5.042 15.165a2.528 2.528 0 0 1-2.52 2.523 2.528 2.528 0 0 1-2.522-2.523 2.528 2.528 0 0 1 2.522-2.52h2.52v2.52zm1.261 0a2.528 2.528 0 0 1 2.52-2.52h5.043a2.528 2.528 0 0 1 2.522 2.52v5.042a2.528 2.528 0 0 1-2.522 2.52H8.824a2.528 2.528 0 0 1-2.52-2.52v-5.042zM9.043 5.043a2.528 2.528 0 0 1 2.52-2.52 2.528 2.528 0 0 1 2.522 2.52v2.52h-2.522a2.528 2.528 0 0 1-2.52-2.52zm0 1.261a2.528 2.528 0 0 1 2.52 2.52v5.043a2.528 2.528 0 0 1-2.52 2.522H6.522A2.528 2.528 0 0 1 4 13.824V8.824a2.528 2.528 0 0 1 2.522-2.52h2.521zM18.958 8.835a2.528 2.528 0 0 1 2.522-2.521 2.528 2.528 0 0 1 2.52 2.521 2.528 2.528 0 0 1-2.52 2.52h-2.522V8.835zm-1.261 0a2.528 2.528 0 0 1-2.52 2.52h-5.043a2.528 2.528 0 0 1-2.522-2.52V3.793a2.528 2.528 0 0 1 2.522-2.52h5.043a2.528 2.528 0 0 1 2.52 2.52v5.042zM14.957 18.958a2.528 2.528 0 0 1-2.52 2.522 2.528 2.528 0 0 1-2.522-2.522v-2.52h2.522a2.528 2.528 0 0 1 2.52 2.52v0zm0-1.261a2.528 2.528 0 0 1-2.52-2.52v-5.043a2.528 2.528 0 0 1 2.52-2.522h2.522a2.528 2.528 0 0 1 2.52 2.522v5.043a2.528 2.528 0 0 1-2.52 2.52h-2.522z" />
  </svg>
);
...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    const fetchSlackStatus = async () => {
      try {
        ...
        if (data.success) {
          setSlackConnected(data.data.connected);
        }
      } catch (err) {}
    };
    fetchSlackStatus();
  ...
  const handleConnectSlack = () => {
    window.location.href = `${import.meta.env.VITE_API_URL}/api/slack/auth`;
  };
  ...
  return (
    <div className="min-h-screen bg-[#f4f6f8] flex overflow-hidden">
      ...
      <aside className="w-[280px] bg-white border-r border-[#e4e8eb] flex flex-col shrink-0">
        ...
        {/* Integrations & Footer Section */}
        <div className="p-4 border-t border-[#f0f2f5] space-y-4">
          {!slackConnected ? (
            <button
              onClick={handleConnectSlack}
              className="w-full flex items-center justify-center gap-2 px-4 py-3 border border-[#e4e8eb] shadow-sm text-xs font-bold rounded-xl text-gray-700 bg-white hover:bg-gray-50 transition-colors cursor-pointer"
            >
              <SlackIcon className="w-4 h-4 text-[#4a154b]" />
              Connect Slack Notification
            </button>
          ) : (
            <div className="flex items-center justify-between px-4 py-3 border border-[#e4e8eb] bg-[#f9fbf9] rounded-xl">
